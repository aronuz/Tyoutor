<template>
  <layout :has-items="true" :home-style="true" :is-loading="isLoading">
    <template v-slot:default>
      <div class="container" fluid height="100%">
        <ui-card width="100vw" class="mx-auto card-row" color="#fff">
          <div class="row-title title-area">
    ...
    <template v-slot:cards>
      <div class="row tutor-row no-gutters">
        <div class="col tutor-col hide-on-big">
          <ui-card color="#FFF" height="100%" width="100%" class="info-sheet">
            <div
